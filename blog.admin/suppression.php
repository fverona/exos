...
// suppression du billet et de ces commentaires si validation dans suppression.valid.php 
if (isset($_POST['action'])) 
{
	if ( $_POST['action'] != 'Abandon' ) 
   {

	$req = $bdd->prepare('delete from billets WHERE id = :billet');

	$req->execute(array('billet' => $_POST['billet']));

	$req = $bdd->prepare('delete from commentaires WHERE id_billet = :billet');
...
?>			 
	<form action="suppression.valid.php" method="post">
		<p class="suppr">
